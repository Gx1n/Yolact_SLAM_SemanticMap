...
def parse_args(argv=None):
    ...
    parser.add_argument('--trained_model',
                        default='/home/x1/catkin_ws/src/Yolact_SLAM/src/yolact/weights/yolact_base_54_800000.pth', type=str,
    ...
    parser.add_argument('--images', default="img:my_image.png", type=str,  # 测试整个数据集
...
def evalimage(net:Yolact, path:str, save_path:str=None):
    ...
    img_numpy, mask_img, img_crop = prep_display(preds, frame, None, None, undo_transform=False)
